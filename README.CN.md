...
与此同时，我们看到其他一些开发者也在研究这个问题，但是他们都面临着**Rails <= 5.0**与**Rails 6**版本兼容性的问题 。两者之间有很大区别，因此，我们通过梳理 `rails 6`, `devise`, `jwt` 这三项技术，实现了三者在Rails中的完美融合，顺利解决了这个难题。与此同时，非常感谢对我这个项目提供很多参考建议的朋友们，比如在这篇文章中： [Rails 5 API + JWT setup in minutes (using Devise)](https://medium.com/@mazik.wyry/rails-5-api-jwt-setup-in-minutes-using-devise-71670fd4ed03) 。
